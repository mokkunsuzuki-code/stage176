...
- Generated: `2026-01-30T07:38:10Z`
- Git commit: `3d435f3`
...
| Attack-04 | **PASS** | `out/logs/attack_04_wrong_session_id.json` | `out/logs/server167_attack04.log:8:[server167] WRONG SESSION_ID DETECTED: phase=WAIT_ACK expected=4100048651583112850 got=4100048651583112851` |
...
### Preview
```
{"stage":176,"attack":"attack_02_replay_ack","ts_utc":"2026-01-30T07:38:07Z","expected":"FAIL_CLOSED","observed":"FAIL_CLOSED_REPLAY_REJECTED","ok":true,"client_rc":0,"artifacts":{"server_log":"out/logs/server167_attack02.log","client_log":"out/logs/client167_attack02.log"}}
...
### Preview
```
{"stage":176,"attack":"attack_03_epoch_rollback","ts_utc":"2026-01-30T07:38:08Z","expected":"FAIL_CLOSED","observed":"FAIL_CLOSED_EPOCH_ROLLBACK_REJECTED","ok":true,"client_rc":0,"artifacts":{"server_log":"out/logs/server167_attack03.log","client_log":"out/logs/client167_attack03.log"}}
...
- Evidence: `out/logs/server167_attack04.log:8:[server167] WRONG SESSION_ID DETECTED: phase=WAIT_ACK expected=4100048651583112850 got=4100048651583112851`

### Preview
```
{"stage":176,"attack":"attack_04_wrong_session_id","ts_utc":"2026-01-30T07:38:08Z","expected":"FAIL_CLOSED","observed":"FAIL_CLOSED_WRONG_SESSION_ID_REJECTED","ok":true,"client_rc":0,"artifacts":{"server_log":"out/logs/server167_attack04.log","client_log":"out/logs/client167_attack04.log"}}
...
### Preview
```
{"stage":176,"attack":"attack_05_key_schedule_confusion","ts_utc":"2026-01-30T07:38:09Z","expected":"FAIL_CLOSED","observed":"FAIL_CLOSED_BAD_ACK_HEADER_REJECTED","ok":true,"client_rc":0,"artifacts":{"server_log":"out/logs/server167_attack05.log","client_log":"out/logs/client167_attack05.log"}}
...
### Preview
```
{"stage":176,"attack":"attack_06_phase_confusion","ts_utc":"2026-01-30T07:38:09Z","expected":"FAIL_CLOSED","observed":"FAIL_CLOSED_PHASE_CONFUSION_REJECTED","ok":true,"client_rc":0,"artifacts":{"server_log":"out/logs/server167_attack06.log","client_log":"out/logs/client167_attack06.log"}}
